...
class PostController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $followingIds = Follower::where('follower_id', $currentUserId)
                ->where('status', 'accepted')
                // Fungsi pluck() di Laravel adalah untuk mengambil nilai dari satu kolom tertentu dari hasil query
                //  database dan mengembalikannya sebagai array (larik), menjadikannya cara cepat untuk mendapatkan
                //  daftar nilai tunggal (seperti daftar ID atau nama) daripada seluruh objek Eloquent, yang 
                // membantu membersihkan kode dan lebih efisien untuk kasus penggunaan spesifik. 
                ->pluck('following_id')
                ->toArray();
